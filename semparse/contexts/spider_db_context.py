...
from dataset_readers.dataset_utils import  read_spider_dataset_schema ,TableColumn ,read_spider_dataset_values
...
class SpiderDBContext:
    ...
    def __init__(self, db_id: str, utterance: str, tokenizer: Tokenizer, tables_file: str, dataset_path: str):
        ...
        if db_id not in SpiderDBContext.schemas:
            SpiderDBContext.schemas = read_spider_dataset_schema(self.tables_file)
    ...
    def get_db_knowledge_graph(self, db_id: str) -> KnowledgeGraph:
        ...
        if db_id not in self.db_tables_data:
            self.db_tables_data[db_id] = read_spider_dataset_values(db_id, self.dataset_path, tables)
