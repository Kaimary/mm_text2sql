...
GRAMMAR_DICTIONARY["select_result"] = ['"*"', '(table_source ws ".*")',
                                       'expr', 'col_ref']
'''
GRAMMAR_DICTIONARY["select_result"] = ['(table_source ws "@*")', 'expr', 'col_ref']
...
GRAMMAR_DICTIONARY["single_source"] = ['source_subq', 'table_source']
'''



GRAMMAR_DICTIONARY["source_subq"] = ['("(" ws query ws ")")', '("(" ws query ws iue ws query ws ")")']
...
GRAMMAR_DICTIONARY["function"] = ['(fname ws "(" ws "distinct" ws arg_list ws ")")',
                                  '(fname ws "(" ws arg_list_or_star ws ")")']

'''
GRAMMAR_DICTIONARY["arg_list_or_star"] = ['arg_list', '"*"']
'''
GRAMMAR_DICTIONARY["arg_list_or_star"] = ['arg_list', '(table_name ws "@*")']
...
GRAMMAR_DICTIONARY["non_literal_number"] = ['"10"', '"1"', '"2"', '"3"', '"4"', '"5"', '"8"']
