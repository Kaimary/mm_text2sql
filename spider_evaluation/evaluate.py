...
def evaluate(gold, predict, question, db_dir, etype, kmaps):
    ...
    for index, instance in enumerate(question_json_blob):
        question_sql_dict[index] = instance['question']
        db_sql_dict[index] = instance['db_id']
    ...
    for p, g in zip(plist, glist):
        ...
        if etype in ["all", "match"]:
            ...
            if exact_score == 0:
                ...
                print("{} question: {}".format(hardness, question_sql_dict[index]))
                print("{} db_id: {}".format(hardness, db_sql_dict[index])) 
                print("")
